  ...
  return (
    <>
      <nav className="fixed top-6 left-0 right-0 z-50 px-4 flex justify-center">
        <div className="w-full max-w-5xl bg-black/80 backdrop-blur-xl border border-white/10 rounded-full px-4 py-3 flex items-center justify-between shadow-2xl relative">
      ...
      {/* Mobile Menu Overlay */}
      {isOpen && (
        <div className="fixed inset-0 z-40 bg-zinc-950/95 backdrop-blur-lg pt-32 px-6">
