...
export const Testimonials: React.FC = () => {
  return (
    <section id="reviews" className="py-16 px-4 bg-gray-100 dark:bg-zinc-950 transition-colors duration-300">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        {testimonials.map((t) => (
          <div key={t.id} className="bg-white dark:bg-zinc-900 p-8 rounded-2xl border border-gray-200 dark:border-zinc-800 hover:border-[#8c59e4]/30 transition-colors shadow-sm dark:shadow-none">
            <Quote className="text-[#8c59e4] mb-4 opacity-50" size={24} />
            <p className="text-zinc-600 dark:text-zinc-300 mb-8 leading-relaxed text-sm">"{t.content}"</p>
